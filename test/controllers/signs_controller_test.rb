...
class SignsControllerTest < ActionController::TestCase
  ...
  test "should create sign" do
    assert_difference('Sign.count') do
      post :create, sign: { kunyomi: @sign.kunyomi, name: @sign.name, onyomi: @sign.onyomi, sign_type: @sign.sign_type, translation: @sign.translation }
    end
  ...
  test "should update sign" do
    patch :update, id: @sign, sign: { kunyomi: @sign.kunyomi, name: @sign.name, onyomi: @sign.onyomi, sign_type: @sign.sign_type, translation: @sign.translation }
    assert_redirected_to sign_path(assigns(:sign))
  end
